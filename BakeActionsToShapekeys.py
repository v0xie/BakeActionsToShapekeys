...
# Copyright (C) 2022 VOXIE3D <www.voxie3d.com>
#
...
"""
# Usage Instructions:
- Paste this file into your text editor
- Edit action_name_filter to match the name of the actions you want to bake 
- Link an Armature and Corrective Smooth modifier to the meshes you want to bake
      Modifiers must have all 4 of the little boxes enabled: Show on Cage, Edit mode, Realtime, Render
- Select the meshes and then the Armature object last
- Run the file in the Text Editor
"""
...
# Parameters
action_name_filter = "Mouth_,Eye_"
    """
    A comma separated list of partial or full action names you want to bake. All matching names will be baked.
        action_name_filter = "Mouth_"  - will only bake actions with Mouth_ in the name
        action_name_filter = "Mouth_,Eye_" - will bake actions with either Mouth_ or Eye_ in the name
    """

delete_old_duplicate_shapekeys = True
    """ Will overwrite any shapekeys with same name """
